...
class RNN3(BaseModel):
    ...
    def create_model(self):
        ...
        self.cell1 = nn.LSTMCell(input_size=self.linear_size, hidden_size=self.rnn_size)
        self.cell2 = nn.LSTMCell(input_size=self.rnn_size, hidden_size=self.rnn_size)
        self.cell3 = nn.LSTMCell(input_size= self.rnn_size, hidden_size=self.rnn_size)
    ...
    def forward(self, batch: AMASSBatch):
        ...
        for i in range((self.seed_seq_len + self.target_seq_len-1)):
            ...
            (state_h, state_c) = self.cell1(state, (state_h, state_c))
            (state_hn2, state_cn2) = self.cell2(state_h, (state_hn2,state_cn2))
